...
\begin{tikzpicture}[auto, node distance=2cm,>=latex']
	...
	\node [block, right of=cpuBorder, node distance=2.5cm] (prepareArgs) {Prepare args};


	\node [sum, right of=prepareArgs, node distance=2cm] (stopStage) {};
	\node [block, right of=stopStage, node distance=1.3cm] (swap) {Swap};
	\node [sum, right of=swap, node distance=1.3cm] (stopStep) {};
