...
PROCUNITGPU=$(SRCPROCUNITGPU)/gpu.cpp $(SRCPROCUNITGPU)/gpu1d.cpp $(SRCPROCUNITGPU)/gpu2d.cpp
...
SOURCE=$(SRC)/main.cpp $(SRC)/domain.cpp $(SRC)/enums.cpp $(SRC)/utils.cpp $(BLOCK) $(PROCUNIT) $(STEPSTORAGE) $(PROBLEM) $(INTERCONNECT)
